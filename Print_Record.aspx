<%@ Page Title="CFID-Print" Language="VB" AutoEventWireup="false" CodeFile="~/Print_Record.aspx.vb"
    ...
    <table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
                               ...
                               <table width="100%" border="0" cellspacing="1" cellpadding="0" class="Light11">
                                    <tr><hr />
                                       <td align="left" valign="top">
                                        ...
                                        <td align="left" valign="middle">
                                            <asp:CheckBox ID="ChkROW" runat="server" Text=" Right-of-Way" />
                                            <asp:CheckBox ID="ChkUTILITY" runat="server" Text=" Utility" />
                                            <asp:CheckBox ID="ChkLIGHTPOLE" runat="server" Text=" Light Pole" />
                                            <asp:CheckBox ID="ChkSIGNAGE" runat="server" Text=" Signage" />
                                            <asp:CheckBox ID="ChkSTRUCTURE" runat="server" Text="Structure" />
        ...
        <tr>
            <td align="center" valign="top">
                ...
                <asp:Button ID="lnkview" runat="server" CssClass="SubmitBt" Text="Back" Width="60px" />
